...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FVZCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"coin-base.info", "fvzseed.coin-base.info"},
    {"miners-point.com", "fvzseed.miners-point.com"},
    {NULL, NULL},
};

static const char *strTestNetDNSSeed[][2] = {
    {"", "fvzseedtest.coin-base.info"},
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FVZCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void RelayFVZSendElectionEntry(const CTxIn vin, const CService addr, const std::vector<unsigned char> vchSig, const int64 nNow, const CPubKey pubkey, const CPubKey pubkey2, const int count, const int current, const int64 lastUpdated)
{
    LOCK(cs_vNodes);
    BOOST_FOREACH(CNode* pnode, vNodes)
    {
...
void RelayFVZSendElectionEntryPing(const CTxIn vin, const std::vector<unsigned char> vchSig, const int64 nNow, const bool stop)
{
    LOCK(cs_vNodes);
    BOOST_FOREACH(CNode* pnode, vNodes)
    {
